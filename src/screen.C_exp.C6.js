...
in version C5 
I cleaned up these functions

rxvt_term.scr_cursor =function(cursor_mode mode){ 
rxvt_term.scr_change_screen =function( scrn){ 

then I realized that I really didn't want to expand every single macro
...
//CMNT: possible_pointer ^|         screen_t *s; 
  ...
  //FIXME these were originally for DEBUG_STRICT
...
rxvt_term.scr_swap_screen =function(){ 
  ...
  //FIXME
  for (var  i = prev_nrow; i--; ) //         for (int i = prev_nrow; i--; ) 
...
rxvt_term.scr_change_screen =function( scrn){ 
  ...
  var i= current_screen; current_screen  = var scrn; scrn = i; //         int i = current_screen; current_screen = scrn; scrn = i; 
      //     # 569 "screen.C"
